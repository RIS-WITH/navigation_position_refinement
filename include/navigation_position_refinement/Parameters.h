#ifndef NAVIGATIONPOSITONREFINEMENT_PARAMETERS_H
#define NAVIGATIONPOSITONREFINEMENT_PARAMETERS_H
...
public:
  ...
  {
    return std::any_of(options_.begin(), options_.end(), [option](auto op)
                       { return option == op; });
  }
...
#endif // NAVIGATIONPOSITONREFINEMENT_PARAMETERS_H
